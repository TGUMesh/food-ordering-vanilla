class ColorBends {
    constructor(containerElement, options = {}) {
        ...
        // Default options mapped from the provided React component
        this.options = {
    ...
    init() {
        ...
        // Ensure container is initialized properly
        this.container.classList.add('color-bends-container');
    ...
    updateUniforms() {
        ...
        this.material.uniforms.uTransparent.value = this.options.transparent ? 1 : 0;
